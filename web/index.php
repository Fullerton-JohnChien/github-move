...
?>
    <title>Tripitta 旅必達</title>
    <meta name="​​description" content="Tripitta旅必達，提供中國、香港、澳門等亞洲地區旅行者到台灣自由行旅遊攻略，民宿訂房及行程規劃。Tripitta旅必達，您最佳的行程規劃助手！">
    ...
    <meta property="og:title" content="Tripitta 旅必達">
    <meta property="og:description" content="Tripitta旅必達，提供中國、香港、澳門等亞洲地區旅行者到台灣自由行旅遊攻略，民宿訂房及行程規劃。Tripitta旅必達，您最佳的行程規劃助手！">
    ...
    <script type="application/ld+json">
        {
            ...
            "description": "Tripitta旅必達，提供中國、香港、澳門等亞洲地區旅行者到台灣自由行旅遊攻略，民宿訂房及行程規劃。Tripitta旅必達，您最佳的行程規劃助手！",
	...
	function show_kv_img(src) {
        ...
        $('#vdo').html('');
        $('#vdo').css('background-image','url("' + src + '?v=20160706")');
	}
...
<body>
	...
	<div class="index-topHeader">
		<img id="logo" src="/web/img/logo.jpg" class="tripittaLogo" onclick="ga('send', 'event', 'TripittaHome', 'click', 'logo', 1);">
		<div class="volume">
		...
		<div class="middleWrap">
			<hgroup class="slogan">
				<h3>WELCOME TO</h3>
				<h1>TAIWAN</h1>
				<h2 id="kv_title" onclick="goTitleLink()" style="cursor: pointer;">你不快看看 現在有什麼好玩的嗎?</h2>
			</hgroup>
			<nav class="menuBar">
				<ul>
	...
	<header class="header"><?php include __DIR__ . '/pages/common/header.php';?></header>
			...
			<div class="foodWrap">
				<div class="left">
					<section class="leftUp">
						<a href="<?php echo $food_1_link?>" class="item1" target="_blank">
							...
							<img style="display: block; width: 100%;height: 100%; background: url(<?php echo $food_1_photo?>) 50% 50%/cover;">
							<div class="detail">
					...
					<section class="leftDown">
						<a href="<?php echo $food_2_link?>" class="item2" target="_blank">
							...
							<img style="display: block; width: 100%;height: 100%; background: url(<?php echo $food_2_photo?>) 50% 50%/cover;">
							<div class="detail">
						...
						<a href="<?php echo $food_3_link?>" class="item3" target="_blank">
							...
							<img style="display: block; width: 100%;height: 100%; background: url(<?php echo $food_3_photo?>) 50% 50%/cover;">
							<div class="detail">
				...
				<div class="right">
					<a href="<?php echo $food_4_link?>" class="item4" target="_blank">
						...
						<img style="display: block; width: 100%;height: 100%; background: url(<?php echo $food_4_photo?>) 50% 50%/cover;">
						<div class="detail">
					...
					<a href="<?php echo $food_5_link?>" class="item5" target="_blank">
						...
						<img style="display: block; width: 100%;height: 100%; background: url(<?php echo $food_5_photo?>) 50% 50%/cover;">
						<div class="detail">
					...
					<a href="<?php echo $food_6_link?>" class="item6" target="_blank">
						...
						<img style="display: block; width: 100%;height: 100%; background: url(<?php echo $food_6_photo?>) 50% 50%/cover;">
						<div class="detail">
...
?>
	...
	<footer class="footer"><?php include __DIR__ . '/pages/common/footer.php';?></footer>
