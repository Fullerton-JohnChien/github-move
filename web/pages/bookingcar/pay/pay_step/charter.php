...
<section id="step2">
	...
	<div class="insurance sec">
		...
		<div class="note">
			注意：
			<br>以上資料請正確填寫，以利為您辦理保險，若提供錯誤請於出發前2日，登入訂單明細做修改，若未提出導致無法投保或理賠，責任由預訂者承擔。
			<br>若暫時無入台證號、護照號或身分證字號可訂購後候補，但請務必於出發前2日，登入訂單明細做修改，請留意。
		</div>
	</div>
...
<div class="popupChartPolicy">
	...
	<div class="content">
		<ul class="popupPolicy">
			...
			<li>半日包車基本時數：<span style="color:blue"><?=$half_day_hour[0]['frd_category_value']?></span>
				小時；一日包車基本時數：<span style="color:blue"><?=$full_day_hour[0]['frd_category_value']?></span>小時。</li>
			...
			<?}?>
			<li>若您有需求附加服務而需加價，實際情況我們最晚於出發前2天通知您是否預訂成功，
				屆時請於現場付予司機。</li>
			<li>以上景點或使用時間及順序將有增減或調整之可能，實際以出車行程表為準。</li>
...
<input type="hidden" id="car_day" name="car_day" value="<?php echo $car_day; ?>" />
</form>
...
<script type="text/javascript">
	...
	$(function(){
        ...
        $('#step1 .pre').on("click", function(){
            var url = "/bookingcar/charter/<?php echo $fr_id; ?>/";
            url += "?car_day=<?php echo $car_day; ?>&begin_date=<?php echo $begin_date; ?>&car_adult=<?php echo $car_adult; ?>&car_child=<?php echo $car_child; ?>";
