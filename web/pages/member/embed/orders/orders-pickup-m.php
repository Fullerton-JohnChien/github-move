...
?>
	<div class="order">
		<div class="info">
			<h2 class="title">
				<div class="tag"><?php echo $type==2 ? "接" : "送"; ?>機</div>
				<div class="titleText"><?php echo $co_prod_name; ?></div>
			</h2>
			<div class="ordnum">
				<span>訂單編號</span>
