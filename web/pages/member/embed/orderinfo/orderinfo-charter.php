...
$partner = $partner_service->get_store($s_id);
$pi_name = $partner['sml_name'];
$pi_contact_email = $partner['s_email'];
$pi_contact_phone = $partner['s_phone'];
$pi_contact_address = $partner['sml_address'];
...
?>
<div class="member-orderinfo-charter-container">
	<div class="order">
		<div class="title">
			<span>訂單明細</span>
	...
	<div class="twoBlockWrap fend">
		<div class="listWrap">
			...
			<div class="lBlock">
				...
				<div class="lData"><?php echo $c_name; ?></div>
			</div>
			<div class="lBlock">
	...
	<div class="policyWrap">
		...
		<div class="policy">
			<div>
				我想要走建議行程：<?php echo $route_spot; ?>
			</div>
			<div class="onge">
				（打勾即同意車隊為您安排的路線，若您有其他想要加入的景點，請訂購後透過訂單訊息與業者聯繫，若超過範圍    則需加價。）
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="rulePolicy">
		...
		<ol class="rule">
			...
			<li>
				半日包車基本時數：<span class="onge"><?php echo $half_day_hour; ?></span> 小時；一日包車基本時數：<span class="onge"><?php echo $day_hour; ?></span> 小時。
			</li>
			<li>
