		...
		<input type="hidden" id="ccNo" name="ccNo"/>
			...
			<form>
				<div class="personalData">
					...
					<div id="memberDiv" style="font-size: 60px;color:red;">您已經是 Tripitta 會員</div>
					<div id="pwdDiv">
						<label>
							<input type="password" class="pwd" placeholder="登入密碼(英文或數字6碼以上)" maxlength="12" name="userPassword" id="userPassword" type="password" >
						</label>
						<label>
							<input type="password" class="pwd2" placeholder="密碼再確認" maxlength="12" name="userPassword2" id="userPassword2" type="password">
						</label>
						<label for="chk" class="clause">
							<input type="checkbox" id="chk" id="policyChk" name="policyChk" class="policyChk" checked>
							<span class="chk">
								本人已閱讀，並已同意<a href="javascript:openRule()">Tripitta會員條款相關規範</a>
							</span>
				...
				<div class="payment">
					<label>
						<select class="paySel" id="cardType" name="cardType">
							...
							<option value="32" selected>信用卡(VISA/Master/JCB)</option>
							<!--<option value="31">支付寶</option>-->
						</select>
					</label>
					<div id="payDiv">
					<h4 style="font-size: 3rem;margin-bottom: 15px;">信用卡卡號</h4>
					...
					<label class="renewCap">
						<div class="btnWrap" onclick="refreshCaptcha();">
							<i class="fa fa-repeat"></i>換一張
						</div>
					</label>
					<label for="receipt" class="receiptDonate">
						<input type="checkbox" id="receipt" name="receipt" checked>
						<span>同意取貨後開立之發票捐贈做愛心，亦同意與辦理取消退貨時，由Tripitta網站代為處理發票銷退事宜，以利加速退款作業。</span>
					</label>
				</div>
			</form>
			<!--
			...
			-->
			<div class="btnWrap">
				<button type="button" class="submit" id="cheakdata" >確認付款</button>
			</div>
		</form>
		</main>
	</div>
